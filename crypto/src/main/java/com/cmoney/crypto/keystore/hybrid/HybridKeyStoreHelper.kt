...
class HybridKeyStoreHelper (
    private val keyStoreSource: HybridKeyStoreSource,
    ...
    override fun storeText(keySet: SecurityKeySet, input: String) {
        require(keySet is SecurityKeySet.HybridKeySet) {
            "Only Use SecurityKeySet.HybridKeySet for keySet"
        }
